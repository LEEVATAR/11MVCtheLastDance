		 ...
		 function execDaumPostcode() {
		        ...
		        new daum.Postcode({
		            oncomplete: function(data) {
		                ...
		                //alert($("input:hidden[name='addr']"));
		                $("input:hidden[name='addr']").val(fullAddr);
		            },		        
		            theme: {
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <!-- input type="text" class="form-control" id="addr" name="addr" placeholder="주소"> -->
				...
				<div class="col-xs-2">
			      	<button type="button" onclick="execDaumPostcode()" class="btn btn-info">주소찾기</button>
		    	</div>		
		    	
		    	<input type="text"  class="form-control" id="postcode" class="ct_input_g" name="postcode" placeholder="우편번호" />			
				<input type="text" class="form-control" id="address" class="ct_input_g"  name="address" placeholder="주소" />
				<input type="text" class="form-control" id="address_detail" class="ct_input_g" name="addressDetail" placeholder="상세주소"/>
